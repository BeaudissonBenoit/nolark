...
<header>
    <picture>
        <source media="(max-width: 576px)" srcset="<?= $dirIndex; ?>images/banniere_small.png">
        <source srcset="<?= $dirIndex; ?>images/banniere.png">
        <img src="<?= $dirIndex; ?>images/banniere.png" alt="Nolark : Protect your minds ! Cette bannière montre un 
