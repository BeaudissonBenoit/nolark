...
function gestionAlcoolemie() {
    ...
    if (alcoolemie >= 0.5) {
        affiche('h3', 'section', 'alcoolemie', 'Alcoolémie : ' + alcoolemie + ' g/l de sang', 'red');
        affiche('h3', 'section', 'amende', 'Amende : ' + getAmende(alcoolemie), 'black');
        affiche('h3', 'section', 'sanction', 'Sanction : ' + getSanction(alcoolemie), 'black');
    } else {
        affiche('h3', 'section', 'alcoolemie', 'Alcoolémie : ' + alcoolemie + ' g/l de sang', 'black');
        supprime('amende');
        supprime('sanction');
    }
}
